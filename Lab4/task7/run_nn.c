...
#define DONE_TASK7 1  // add on-chip SRAM
...
int main()
{
    *hex = 0x3f; /* display - */
    ...
    //result = dotprod_hw(3, l1_w, input);

    //result = dotprod_hw(2, l1_w, input);


    //int w[] = {0x10000, 0x20000, 0x30000, 0x40000};
    //int a[] = {0x50000, 0x60000, 0x70000, 0x80000};
    //result = dotprod_hw(1, w, a);
