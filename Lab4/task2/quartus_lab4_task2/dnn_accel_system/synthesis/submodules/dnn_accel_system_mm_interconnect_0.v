...
module dnn_accel_system_mm_interconnect_0 (
	...
	wire  [103:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> LEDs_s1_agent:cp_data
	...
	wire  [103:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> switches_s1_agent:cp_data
	...
	wire  [103:0] leds_s1_agent_rp_data;                                                              // LEDs_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [103:0] switches_s1_agent_rp_data;                                                          // switches_s1_agent:rp_data -> router_006:sink_data
	...
	wire   [85:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire   [85:0] router_007_src_data;                                                                // router_007:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                               // new_sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [6:0] router_007_src_channel;                                                             // router_007:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire  [103:0] new_sdram_controller_0_s1_rsp_width_adapter_src_data;                               // new_sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	...
	wire    [6:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;                            // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire  [103:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> new_sdram_controller_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                              // new_sdram_controller_0_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	dnn_accel_system_mm_interconnect_0_router_002 router_008 (
