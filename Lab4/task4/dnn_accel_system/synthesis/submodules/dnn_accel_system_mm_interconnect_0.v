...
module dnn_accel_system_mm_interconnect_0 (
	...
	wire    [7:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> vga_avalon_0_avalon_slave_0_agent:cp_channel
	...
	wire  [103:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> pio_0_s1_agent:cp_data
	...
	wire   [85:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [103:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_009:sink_data
	...
	wire   [85:0] router_008_src_data;                                                                // router_008:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	...
	wire  [103:0] new_sdram_controller_0_s1_rsp_width_adapter_src_data;                               // new_sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	...
	wire  [103:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> new_sdram_controller_0_s1_cmd_width_adapter:in_data
	...
	dnn_accel_system_mm_interconnect_0_router_002 router_007 (
	...
	dnn_accel_system_mm_interconnect_0_router_002 router_009 (
	...
	dnn_accel_system_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (pll_0_outclk0_clk),                              //       clk.clk
		.reset               (vga_avalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (vga_avalon_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
